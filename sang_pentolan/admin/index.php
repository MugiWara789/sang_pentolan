<?php
    ...
    $divisi_data = array();
    if ($id_admin > 0) {
        $statement = $db->query("SELECT nama_divisi, COUNT(*) as jumlah_laporan FROM laporan, divisi WHERE laporan.tujuan = divisi.id_divisi AND laporan.tujuan = $id_admin GROUP BY nama_divisi");
    } else {
        $statement = $db->query("SELECT nama_divisi, COUNT(*) as jumlah_laporan FROM laporan, divisi WHERE laporan.tujuan = divisi.id_divisi GROUP BY nama_divisi");
    }

    foreach ($statement as $row) {
        $divisi_data[$row['nama_divisi']] = $row['jumlah_laporan'];
    }
...
<head>
    ...
    <title>Admin - SANg PENTOLAN</title>
    <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">SANg PENTOLAN</a>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-table"></i> Statistik Kategori Laporan
                </div>
                <!-- <tbody> -->
                <?php
            ...
            <script>
                var divisiData = <?php echo json_encode($divisi_data); ?>;
                ...
                // Tambahkan keterangan jumlah di sebelah diagram
                var keteranganDiv = document.getElementById('keterangan');
                Object.keys(divisiData).forEach(function(divisi) {
                    var jumlah = divisiData[divisi];
                    var keteranganItem = document.createElement('p');
                    keteranganItem.innerHTML = divisi + ': ' + jumlah + ' laporan';
                    keteranganDiv.appendChild(keteranganItem);
                });
            </script>
        </div>
        <!-- /.container-fluid-->
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>© 2023 | Dinsosdaldukkbp3a Purbalingga</small>
                </div>
            </div>
        </footer>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="text-align : center;">© 2023 | Dinsosdaldukkbp3a Purbalingga</p>
                    </div>
                    <div class="modal-footer">
